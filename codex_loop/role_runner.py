...
ROLE_INSTRUCTIONS = {
    ...
    "spec_evaluator": (
        ...
        "not_evaluated. If evidence is insufficient but a concrete code or test change "
        "can repair the gap, return status=repairable and provide repair_actions. Use "
        "needs_human only for unresolved product, architecture, security, or scope "
        "decisions. "
