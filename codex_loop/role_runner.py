...
ROLE_INSTRUCTIONS = {
    ...
    "spec_evaluator": (
        ...
        "not_evaluated. If a concrete code or test change can repair the gap, return "
        "status=repairable and provide repair_actions. Use needs_human for unresolved "
        "product, architecture, security, scope, infrastructure, or evidence decisions; "
        "do not turn an actionless failure into an automatic repair. "
    ...
    "architecture_evaluator": (
        ...
        "least one finding.status to be fail; repairable requires at least one "
        "finding.status=repairable with repair_actions; needs_human requires at least one "
