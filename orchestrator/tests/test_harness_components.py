...
from orchestrator.codex_loop.context import ContextAssembler, ContextSnapshot
from orchestrator.codex_loop.evaluation import (
...
from orchestrator.codex_loop.knowledge import (
    KnowledgeItem,
    KnowledgeSelection,
)
from orchestrator.codex_loop.mcp_client import LocalMcpClient, McpCallError
from orchestrator.codex_loop.memory import MediumTermMemory
from orchestrator.codex_loop.models import InfrastructureError, TaskQueueSpec, TaskSpec
from orchestrator.codex_loop.planner import (
    PlannedSubtask,
    PlannerRoleOutput,
    PlannerService,
    append_plan_event,
)
from orchestrator.codex_loop.role_runner import StructuredRoleRunner
...
def test_medium_term_memory_uses_fixed_formula_alias_dedupe_and_stable_ties(
    ...
    common = {
        ...
        "tags": ["filter"],
        "paths": ["orchestrator/frontend/src/view.ts"],
        "technologies": ["vue"],
    ...
    recalled = memory.recall(
        query="前端 frontend",
        tags=["filter"],
        paths=["orchestrator/frontend/src/other.ts"],
        technologies=["vue"],
    )
